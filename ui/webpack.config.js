...
var localeCatalogPath = path.join(__dirname, 'locale', 'catalogs.json');
...
var config = {
  ...
  plugins: [
    ...
    new webpack.ContextReplacementPlugin(
      ...
      path.join(__dirname, 'locale', path.sep),
      true,
  ...
  resolve: {
    alias: {
      ...
      'sentry-locale': path.join(__dirname, 'locale')
    },
